...
export default function PsychologyPage() {
    ...
    const loadPatients = () => {
        ...
        const psychologyRecords = allRecords.filter(r => r.template === 'psychology');
        setPatients(psychologyRecords);
    };
            ...
            <div className="min-h-screen p-4 sm:p-8">
                <div className="max-w-4xl mx-auto space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-bold">Psikoloji</h1>
            ...
            <div className="max-w-5xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Psikoloji Değerlendirmesi</p>
                    </div>
                </div>
                ...
                {result && <ResultDisplay result={result} mode="psychology" />}
            </div>
        </div>
    );
}
